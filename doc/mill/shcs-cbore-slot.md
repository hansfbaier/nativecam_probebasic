...
>"<b>Creates a counterbore slot from a single point for a socket head cap screw</b>&#10;Will mill the screw slot&#10;<span foreground='blue' style='oblique'><b>Message possible in terminal window</b></span>"

| | |
|---|---|
| Type | `shcs_cbore_s` |
| Icon | `shcs-slot.png` |
| Source | `mill/SHCS_slot.cfg` |
...
| 6 | "Y" | Float | `0.0000` |
| | **"Size, rotation"** | | |
| 8 | "Effective length" | Float | `1.0000` |
| 9 | "Rotation" | Float | `60.00` |
| | **"Screw"** | | |
...
- "Diameter of washer used if any"
in usual units
- **Min**: 0.0  **Max**: 999999.9  **Digits**: 4

### "Thickness"
- **NGC variable**: `#param_wt`
- "Thickness of washer used if any"
in usual units
- **Min**: 0.0  **Max**: 999999.9  **Digits**: 4
