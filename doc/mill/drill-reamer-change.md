...
>"<b>Change Drill and/or settings</b>&#10;Changes setting accordingly even if disabled"

| | |
|---|---|
| Type | `drill_chng` |
| Icon | `drill.png` |
| Source | `mill/sel-drill.cfg` |
...
|---|-----------|------|---------|
| 1 | "Active" | Toggle | `1` |
| | **"Select drill or reamer"** | | |
| 3 | "Tool number" | tool | `0` |
| 4 | "Select drill size" | Dropdown (editable) | `1` |
| 5 | "Fractional drill" | List | `0.3125` |
| 6 | "Metric drill" | List | `0.2362` |
| 7 | "Wire gauge drill" | List | `0.1285` |
| 8 | "Lettered drill" | List | `0.257` |
| 9 | User defined size | Float | `0.3750` |
| 10 | User defined size | G-code | `` |
| 11 | "Point angle" | Dropdown | `118` |
| | **"Action"** | | |
| 13 | "Use length comp" | Dropdown | `3` |
| 14 | "Start spindle" | Dropdown | `3` |
| 15 | "Use cooling" | Dropdown | `8` |
| | **"Feed and speed"** | | |
| 17 | "Drilling feed" | Float | `1.0000` |
| 18 | "Spindle speed" | Integer | `2000` |
| | **"Drilling params"** | | |
| 20 | "Mode" | Dropdown | `81` |
| 21 | "Retract (R)" | Float | `0.0200` |
| 22 | "Dwell (P)" | Float | `2.0000` |
| 23 | "Delta (Q)" | Float | `0.2000` |
...
### "Select drill size"
- **NGC variable**: `#param_drill`
- "Select defined drill or enter size"
- **Options**: "User defined=0:Fractional=1:Metric=2:Letter=3:Wire gauge=4:G-Code=5"

### "Fractional drill"
- **NGC variable**: `#param_d_fra`
- "Fractional drill"
...
### User defined size
- **NGC variable**: `#param_d_usr`
- User defined size
- **Min**: 0.0  **Max**: 999999.9  **Digits**: 4

### User defined size
- **NGC variable**: `#param_d_usrg`
- User defined size

### "Point angle"
- **NGC variable**: `#param_tip`
- "Drill point angle"
- **Options**: "118&#176; Medium hard material=118:135&#176; Hard material=135:90&#176; Plastic=90:60&#176; Plastic=60:Flat end=180"
...
### "Mode"
- **NGC variable**: `#param_dm`
- "G73 requires Q>0 and R&#10;G81 requires R&#10;G82 requires R and P&#10;G83 requires Q>0 and R"
- **Options**: "Manual=0:With Chip Breaking - G73=73:Standard - G81=81:Dwell at bottom - G82=82:Peck Drilling Cycle - G83=83"

### "Retract (R)"
- **NGC variable**: `#param_retract`
- "Retract height"
- **Min**: -999999.9  **Max**: 999999.9  **Digits**: 4

### "Dwell (P)"
- **NGC variable**: `#param_dw`
- "Dwell in seconds"
- **Min**: 0  **Max**: 999999.9  **Digits**: 4

### "Delta (Q)"
- **NGC variable**: `#param_dq`
- "Delta (Q)"
- **Min**: 0.001  **Max**: 999999.9  **Digits**: 4
